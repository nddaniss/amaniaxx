...
<body class="bg-[#F7C8E0] text-[#3a4a37] antialiased m-0 p-0">
    ...
    <nav class="bg-[#fde4ef] px-6 py-4 flex justify-between items-center shadow-sm md:px-10">
    ...
    <section class="flex flex-col lg:flex-row items-center gap-8 px-6 py-8 md:px-12 md:py-12">
        <div class="w-full lg:w-1/2 text-center lg:text-left">
            <h2 class="text-[#8C6239] font-bold text-4xl md:text-6xl mb-4 font-['Playfair_Display']">
                Sweet Moments Begin with Amaniax
            </h2>
            <p class="text-[#3A4A37] text-lg mb-6 leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                @auth
                    <a href="{{ route('customer.menu') }}" class="inline-block">
                        <button class="bg-[#A6E3E9] text-[#8C6239] text-lg font-bold px-6 py-3 border-2 border-[#6BBBC3] rounded-xl shadow-md hover:bg-[#6BBBC3] hover:text-[#465940] transition duration-300 w-full sm:w-auto">
                            Go to Menu & Order
                        </button>
                    </a>
                @else
                    ...
                    <a href="{{ route('register') }}" class="inline-block">
                        <button class="bg-transparent text-[#8C6239] text-lg font-bold px-6 py-3 border-2 border-[#8C6239] rounded-xl hover:bg-[#8C6239] hover:text-white transition duration-300 w-full sm:w-auto">
                            Sign Up Now
                        </button>
                    </a>
                @endauth
        ...
        <div class="w-full lg:w-1/2 flex justify-center">
            <img src="{{ asset('images/amaniax_hero.png') }}" alt="Amaniax Cafe" class="w-full h-auto rounded-2xl shadow-xl max-w-lg object-cover aspect-[3/2]">
        </div>
    </section>

    <section class="flex flex-col-reverse lg:flex-row items-center gap-8 px-6 py-16 md:px-24">
        <div class="w-full lg:w-1/2 flex justify-center">
            <img src="{{ asset('images/amaniaxbuilding.jpg') }}" alt="Amaniax Building" class="w-full h-auto rounded-2xl shadow-xl max-w-lg object-cover aspect-[3/2]">
        </div>

        <div class="w-full lg:w-1/2 bg-[#FFF6BD]/75 p-8 rounded-[32px] shadow-lg">
    ...
    <div class="text-center mt-10 mb-8 px-4">
        <h2 class="text-[#8C6239] font-bold text-4xl md:text-5xl font-['Playfair_Display']">What Makes Us Special?</h2>
    </div>

    <section class="flex flex-wrap justify-center gap-6 px-6 pb-16 max-w-7xl mx-auto">
        <div class="w-full md:w-[48%] lg:w-[30%] bg-[#A6E3E9]/75 p-6 rounded-[32px] shadow-lg">
            <img src="{{ asset('images/cozycafe.jpg') }}" alt="Cozy Cafe" class="w-full h-48 object-cover rounded-2xl shadow-md mb-4 mx-auto block">
            ...
            <p class="text-[#3A4A37] text-center leading-relaxed">
                Amaniax Café offers a warm, cozy, and Instagram-worthy atmosphere that makes every visit feel comfortable and relaxing.
            </p>
        </div>

        <div class="w-full md:w-[48%] lg:w-[30%] bg-[#A6E3E9]/75 p-6 rounded-[32px] shadow-lg">
            <img src="{{ asset('images/dessert.jpg') }}" alt="Dessert" class="w-full h-48 object-cover rounded-2xl shadow-md mb-4 mx-auto block">
        ...
        <div class="w-full md:w-[48%] lg:w-[30%] bg-[#A6E3E9]/75 p-6 rounded-[32px] shadow-lg">
            <img src="{{ asset('images/promo1.jpg') }}" alt="Promo" class="w-full h-48 object-cover rounded-2xl shadow-md mb-4 mx-auto block">
    ...
    <footer class="bg-[#E6A9C8] pt-12 pb-6 mt-10">
